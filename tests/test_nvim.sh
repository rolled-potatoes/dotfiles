...
export NVIM_LOG_FILE="$temporary_root/nvim.log"
...
nvim --headless -i NONE -u "$ROOT/tests/nvim/minimal_init.lua" "$project_dir/src/sample.lua" -l "$ROOT/tests/nvim/test_code_notes.lua"
...
nvim --headless -i NONE -u "$ROOT/tests/nvim/minimal_init.lua" -R "$project_dir/src/sample.lua" \
...
CODE_NOTES_TEST_PROJECT_DIR="$project_dir" \
CODE_NOTES_TEST_NOTES_DIR="$notes_dir" \
nvim --headless -i NONE -u "$ROOT/tests/nvim/minimal_init.lua" "$project_dir/src/sample.lua" \
...
nvim --headless -i NONE -u "$ROOT/tests/nvim/minimal_init.lua" +qa
